%function [ ] = MCMC4eeg()
%
% MCMC4EEG on the UCI data (http://archive.ics.uci.edu/ml/datasets/EEG+Database)
%
% Based on the algorithm from D.H. Hald, S.E. Grützmeier, S. Harder, C.I.
% Blücher: An ICA algorithm based on MCMC

load data1      % V = 61 x 256 double
...
% Sampler structure
prs.m = d;          % Number of components
prs.chains = 1;     % Number of chains
prs.skip = 20;     % number of samples to burn
prs.nsamples = 100; % total number of steps
